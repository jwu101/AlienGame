...
class AlienInvasion:
    ...
    def _ship_hit(self):
        """Respond to the ship beign hit by an alien"""
    ...
    def _update_aliens(self):
        """Check if the fleet is at en edge, then update the positions of all aliens in the fleet"""
    ...
    def _change_fleet_direction(self):
        ...
        self.ship.screen.fill(self.settings.bg_color)
        self.ship.blitme()
